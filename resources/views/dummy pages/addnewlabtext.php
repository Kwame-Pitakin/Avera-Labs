                                ...
                                <div class="row">
                                    ...
                                    {{-- <div class="mb-3 col-lg-6 col-xl-3 col-12 mb-0">
                                        ...
                                        <select id="select2Basic" class="select2 form-select form-select-lg"
                                            data-allow-clear="true" name=[test_name]>
                                            <option value="Select Cat" disabled selected>Select Test Category</option>
                                            <option value="Organ function tests">Organ function tests</option>
                                            <option value="Sexually transmitted infection tests">Sexually transmitted
                                                infection tests</option>
                                            <option value="Screening tests">Screening tests</option>
                                            <option value="Cholesterol level tests">Cholesterol level tests</option>
                                            <option value="Nutrient and vitamin level tests">Nutrient and vitamin level
                                                tests</option>
                                    ...
                                    <div class="mb-3 col-lg-6 col-xl-3 col-12 mb-0">
                                        ...
                                        <select id="select2Basic" class="select2 form-select form-select-lg"
                                            data-allow-clear="true" name=[test_name]>
                                            <option value="Select Cat" disabled selected>Select Test Category</option>
                                            <option value="1">Organ function tests</option>
                                            <option value="2">Sexually transmitted
                                                infection tests</option>
                                            <option value="3">Screening tests</option>
                                            <option value="4">Cholesterol level tests</option>
                                            <option value="5">Nutrient and vitamin level
                                                tests</option>
                                            <option value="6">Infectious disease tests</option>
                                        </select>
                                    </div>
