        ...
        <div class="authentication-inner row m-0">
            ...
            <div class="d-flex col-12 col-lg-5 col-xl-4 align-items-center authentication-bg p-sm-5 p-4">
                <div class="w-px-400 mx-auto">
                    ...
                    <!-- /Logo -->
                    <h4 class="mb-2">Lab Agent Registration 🚀</h4>
                    ...
                    <form id="formAuthentication" class="mb-3" action="/users" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="fullname" name="fullname"
                                placeholder="Enter your username" autofocus required value="{{ old('fullname') }}" />
                            @error('fullname')
                        ...
                        <div class="mb-3 form-password-toggle">
                            ...
                            <div class="input-group input-group-merge">
                                <input type="password" id="password_confirmation" class="form-control"
                                    ...
                                    placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;"
                                    aria-describedby="password_confirmation" required  value="{{ old('password_confirmation') }}"/>
                                <span class="input-group-text cursor-pointer"><i class="bx bx-hide"></i></span>
                            </div>
