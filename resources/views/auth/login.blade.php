    ...
    <div class="authentication-inner row m-0">
      ...
      <div class="d-none d-lg-flex col-lg-7 col-xl-8 align-items-center">
        <div class="flex-row text-center mx-auto">
          ...
          />
          <div class="mx-auto">
            <h3>Leave nothing to chance! Verify ! You deserve a good life </h3>
            <p>
              Get access to over 100 acredited laboratories <br> Who offer Descrete, confidential STD/STI tests or request for home testing. <br> No queues, get your results via our secured Modile aplication. <br>
               With the tests results sent to your mobile App, you can now prove your STI status and also ask for proof.
            </p>
          </div>
        </div>
      </div>
