        ...
        <div class="user-profile-header d-flex flex-column flex-sm-row text-sm-start text-center mb-4">
          ...
          <div class="flex-grow-1 mt-3 mt-sm-5">
            ...
            >
              ...
              <a href="{{ route('user.edit',Auth::user()->id) }}" class="btn btn-primary text-nowrap">
  ...
  <div class="row">
    <div class="col-md-12">
      <ul class="nav nav-pills flex-column flex-sm-row mb-4">
        ...
        <li class="nav-item">
          <a class="nav-link" href="pages-profile-teams.html"><i class="bx bx-group"></i> Laboratories</a>
        </li>
        <li class="nav-item">
          ...
          <ul class="list-unstyled mt-3 mb-0">
            <li class="d-flex align-items-center mb-3">
              ...
              <div class="d-flex flex-wrap">
                <span class="fw-semibold me-2">Labs signed</span><span>(126 Members)</span>
              </div>
            </li>
