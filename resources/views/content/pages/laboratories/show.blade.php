        ...
        <div class="row gy-4">
            ...
            <div x-data="{ tab: 'Tests' }" class="col-xl-8 col-lg-7 col-md-7 order-0 order-md-1">
                ...
                <ul class="nav nav-pills flex-column flex-md-row mb-3">
                    <li class="nav-item">
                        <a :class="{ 'active': tab === 'Tests' }" x-on:click.prevent="tab = 'Tests'" href="#"
                            class="nav-link "><i class="menu-icon bx bx-test-tube"></i>Tests</a>
                    </li>
                    <li class="nav-item">
                        <a :class="{ 'active': tab === 'combo' }" x-on:click.prevent="tab = 'combo'" href="#"
                            class="nav-link"><i class="bx bx-user  me-1"></i>Combo</a>
                    </li>
                    <li class="nav-item">
                        <a :class="{ 'active': tab === 'stuff' }" x-on:click.prevent="tab = 'stuff'" href="#"
                            class="nav-link"><i class="bx bx-detail me-1"></i>Stuff</a>
                    </li>
                    <li class="nav-item">
                        <a :class="{ 'active': tab === 'Notifications' }" x-on:click.prevent="tab = 'Notifications'"
                            href="#" class="nav-link"><i class="bx bx-bell me-1"></i>Notifications</a>
                    </li>
                    <li class="nav-item">
                        <a :class="{ 'active': tab === 'Connections' }" x-on:click.prevent="tab = 'Connections'"
                            href="#" class="nav-link"><i class="bx bx-link-alt me-1"></i>Connections</a>
                    </li>
                </ul>
                <!-- Lab Tests -->
                ...
                <div x-show="tab === 'Tests'" class="card mb-4">
                    ...
                    <div class="row  card-header">
                        ...
                        <div class="col-6">
                            <a href="{{ route('labtest.create', $labDetails->id) }}"
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center mb-3">
                                            <a href="javascript:;" class="d-flex align-items-center">
                                                ...
                                                <div class="me-2 text-body span mb-0"
                                                    style="color: #237381 !important;font-weight:800">
                                        ...
                                        <div class="ms-auto">
                                            ...
                                            <span class=" me-1 tooltip-help" style="float: right"
                                        ...
                                        <div class="d-flex align-items-center flex-wrap gap-1">
                                            ...
                                            <div class="ms-auto">
                                                <a href="javascript:;" class="me-1">
                                                    <span class="badge bg-label-warning">GHC
                                                        &nbsp;{{ $comboDetails->combo_price }}
                                                    </span>
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <div class="mt-3">
                                    ...
                                    <div class="offcanvas offcanvas-end " tabindex="-1" id="offcanvasAddUser"
                                        ...
                                        <div class="offcanvas-body mx-0 flex-grow-0">
                                            ...
                                            <form id="formAuthentication" class="add-new-user pt-0"
                                                action="{{ route('labStuff.store') }}" method="POST"
                                                enctype="multipart/form-data">
                                                @csrf
                                                {{-- uploading profile image --}}

                                                <input type="text" name="works_at" readonly id=""
                                                    value="{{ $labDetails->id }}" hidden>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="userFullname"
                                                        name="userFullname" placeholder="Enter your username" autofocus
                                                        required value="{{ old('userFullname') }}" />
                                                    @error('userFullname')
                                                        <p class="error">{{ $message }}</p>
                                                    @enderror
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select id="user-role" class="select2 form-select" name="role">
                                                        ...
                                                        <option value="Front Desk"
                                                            {{ old('role') === 'Front Desk' ? 'selected' : '' }}> Front
                                                            Desk
                                                        </option>
                                                        <option value="Lab Technician"
                                                            {{ old('role') === 'Lab Technician' ? 'selected' : '' }}> Lab
                                                            Technician </option>
                                                        </option>
                                                    </select>
                                                    @error('role')
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="userEmail"
                                                        name="userEmail" placeholder="Enter your user email" required
                                                        value="{{ old('userEmail') }}" />
                                                    @error('userEmail')
                                                        <p class="error">{{ $message }}</p>
                                                    @enderror
                                                ...
                                                <div class="mb-3 ">
                                                    ...
                                                    <div class="input-group input-group-merge">
                                                        <span class="input-group-text">
                                                            ...
                                                            (+233)</span>
                                                        <input class="form-control mobile-number" type="number"
                                                            id="userContact" name="userContact"
                                                            placeholder="202 555 0111" min="9" max="10"
                                                            value="{{ old('userContact') }}" required />
                                                    </div>
                                                    @error('userContact')
                                                        <p class="error">{{ $message }}</p>
                                                    @enderror
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" id="add-user-location" class="form-control"
                                                        placeholder="Enter Your Google Map Location"
                                                        aria-label="User Location" name="userLocation"
                                                        value="{{ old('userLocation') }}" />
                                                    @error('userLocation')
                                                        <p class="error">{{ $message }}</p>
                                                    @enderror
                                                </div>
                                                ...
                                                <button type="reset" class="btn btn-label-secondary"
                                                    style="float: right" data-bs-dismiss="offcanvas">Cancel</button>
                                            </form>
                                        </div>
                                            ...
                                            @if (!empty($stuff->getRoleNames()))
                                                @foreach ($stuff->getRoleNames() as $stuffRole)
                                                    ...
                                                    @else
                                                        <td>
                                                            <span
                                                                class="badge badge-center rounded-pill bg-label-info w-px-30 h-px-30 me-2"></span>
                                                            Role Not Assigned
                                                        </td>
                                                    @endif
                                                @endforeach
