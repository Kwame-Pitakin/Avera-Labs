         ...
         <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
             ...
             <ul class="menu-inner py-1">
                 ...
                 <li class="menu-item">
                     <a href="{{ asset('laboratories') }}" class="menu-link">
                         <i class="menu-icon tf-icons bx bx-clinic"></i>
                         <div data-i18n="Laboratories">Laboratories</div>
                     </a>
                 </li>
                 <li class="menu-item">
                     <a href="{{ asset('tests') }}" class="menu-link">
                         <i class='menu-icon bx bx-test-tube'></i>
                         <div data-i18n="Tests">Tests</div>
                     </a>
                 </li>
                 <li class="menu-item">
                     <a href="{{ route('laboratories.create') }}" class="menu-link">
                         <i class="menu-icon tf-icons bx bx-plus-medical"></i>
                         <div data-i18n="Add Laboratory">Add Laboratory</div>
                     </a>
                 </li>
                 <li class="menu-item">
