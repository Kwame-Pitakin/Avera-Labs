...
class PermissionSeeder extends Seeder
{
    ...
    //    app()[PermissionRegistrar::class]->forgetCachedPermissions();
        ...
        //lab-workers
        Permission::create(['name' => 'create-lab-workers']);
        Permission::create(['name' => 'edit-lab-workers']);
        Permission::create(['name' => 'delete-lab-workers']);
        Permission::create(['name' => 'archive-lab-workers']);
        ...
        Permission::create(['name' => 'list-laboratories']);
        ...
        // tests is labs
        Permission::create(['name' => 'add-lab-tests']);  //adding tests to laboratory
        Permission::create(['name' => 'edit-lab-tests']);  //adding tests to laboratory
        Permission::create(['name' => 'remove-lab-tests']); // remove tests from laboratory list
        Permission::create(['name' => 'archive-lab-tests']); // archive tests from laboratory list
        ...
        Permission::create(['name' => 'archive-bookings',
    ]);
